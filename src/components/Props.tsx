 ...
 * valley rim, and fences flanking the gate.
 */
...
const PROPS: PropPlacement[] = [
  ...
  { model: 'cottage.glb', position: [46, 0, -28], rotationY: 0.9, scale: 10 },
  { model: 'cottage.glb', position: [36, 0, -22], rotationY: -0.3, scale: 10 },
  { model: 'logcabin.glb', position: [56, 0.5, -16], rotationY: 0.7, scale: 0.008 },
  { model: 'well.glb', position: [43, 0.55, -25], rotationY: 0.5, scale: 2.2 },
  ...
  { model: 'cliff.glb', position: [-132, 26.4, -124], rotationY: 0.5, scale: 0.035 },
  { model: 'cliff.glb', position: [134, 26.4, 122], rotationY: 2.0, scale: 0.035 },

  // ---- Hedge clusters along the valley floor ----
  { model: 'bush.glb', position: [30, 0.86, -25], rotationY: 0.3, scale: 1.5 },
  { model: 'bush.glb', position: [16, 0.86, -66], rotationY: 0.9, scale: 1.5 },
